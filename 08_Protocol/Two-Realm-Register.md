...
|---|---|---|---|---|
| W1 | قطعیت بند بحرانی b_c: «دهک جهانی» اندازه‌محدود است | ابزار: همان گِید K1 در L=512/1024 | سنجش L-dependence → قطعیِ 15.75±0.25 | pending (وثیقه: گِید موجود) |
...
| W6 | پنج لنگر مستندنشدهٔ §۹ (کانت، راسل، گروتندیک، فاینمن، نوتر) | ابزار: همان پروتکل LG (ارجاع راستی‌آزمایی‌شده + جدول نگاشت) | چهار نمونهٔ اجراشده الگوست | pending (وثیقه: LG-1..4) |
...
| کمیت | مقدار | منبع |
|---|---|---|
| پرسش‌های پرچم‌دار قلمرو کار | ۷ | همین سند |
| پرسش‌های پرچم‌دار قلمرو حرمت | ۴ | همین سند |
| نسبت کنونی | 7:4 | بازبینی با هر هم‌ترازیِ تازه |
